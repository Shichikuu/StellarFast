...
public class GuestInvitationPage {
    ...
    private void fetchInvitations() {
        try {
            List<Invitation> invitations = gc.getInvitations(guestEmail);
    ...
    private void acceptInvitation() {
        ...
        try {
            gc.acceptInvitation(selectedInvitation.getEvent_id());
